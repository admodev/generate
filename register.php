            ...
            <div class="container my-auto formulario">
                  ...
                  <form method="POST" action="opciones_pago.php" class="mt-5 d-flex flex-lg-row formulario-columna">
                        <div class="col-lg">
                              ...
                              <select name="pais" class="form-control m-2" required>
                                    <option selected="selected">Pais</option>
                                    <?php
                                    foreach ($countries as $pais) {
                                    ?>
                                          <option value="<?php echo strtolower($pais); ?>"> <?php echo $pais; ?> </option>
                                    <?php
                        ...
                        <div class="col-lg">
                              ...
                              <input type="submit" name="reg_user" value="Registrarme" class="btn btn-primary m-2 p-2" style="background-color: transparent;
  padding: 2px 7px;
